...
class ModuleCreateCommand(Command):
    ...
    def handle(self):
        ...
        controller_content = self.render_stub_file(os.path.join(get_module_dir(__file__), "../stubs/controller.skeleton"), f"{moduleName}Controller")
        model_content = self.render_stub_file(os.path.join(get_module_dir(__file__), "../stubs/model.skeleton"), moduleName)
        route_content = self.render_stub_file(os.path.join(get_module_dir(__file__), "../stubs/route.skeleton"), f"{moduleName}Controller")
        
        layout_content = self.render_stub_file(os.path.join(get_module_dir(__file__), "../stubs/layout.skeleton"), f"{moduleName}Layout")
        index_content = self.render_stub_file(os.path.join(get_module_dir(__file__), "../stubs/index.skeleton"), f"{moduleName}Index")
