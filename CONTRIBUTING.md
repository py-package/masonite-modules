...
1. Fork the `https://github.com/yubarajshrestha/masonite-modules` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/masonite_modules.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall masonite_modules && pip install .`
